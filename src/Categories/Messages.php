...
class Messages
{
     ...
     */
    public function send($message, $async = false, $ipPool = null, $sendAt = null) // phpcs:enable Generic.Files.LineLength.TooLong
    {
        $_params = ['message' => $message, 'async' => $async, 'ip_pool' => $ipPool, 'send_at' => $sendAt];
     ...
     *               - _id string the message's unique id
     */
    public function sendTemplate($templateName, $templateContent, $message, $async = false, $ipPool = null, $sendAt = null) // phpcs:enable Generic.Files.LineLength.TooLong
    {
        $_params = ['template_name' => $templateName, 'template_content' => $templateContent, 'message' => $message, 'async' => $async, 'ip_pool' => $ipPool, 'send_at' => $sendAt];
     ...
     */
    public function search($query = '*', $dateFrom = null, $dateTo = null, $tags = null, $senders = null, $apiKeys = null, $limit = 100) // phpcs:enable Generic.Files.LineLength.TooLong
    {
        $_params = ['query' => $query, 'date_from' => $dateFrom, 'date_to' => $dateTo, 'tags' => $tags, 'senders' => $senders, 'api_keys' => $apiKeys, 'limit' => $limit];
    ...
    {
        $_params = ['query' => $query, 'date_from' => $dateFrom, 'date_to' => $dateTo, 'tags' => $tags, 'senders' => $senders];
    ...
    {
        $_params = ['raw_message' => $rawMessage];
     ...
     *               - _id string the message's unique id
     */
    public function sendRaw($rawMessage, $fromEmail = null, $fromName = null, $to = null, $async = false, $ipPool = null, $sendAt = null, $returnPathDomain = null) // phpcs:enable Generic.Files.LineLength.TooLong
    {
        $_params = ['raw_message' => $rawMessage, 'from_email' => $fromEmail, 'from_name' => $fromName, 'to' => $to, 'async' => $async, 'ip_pool' => $ipPool, 'send_at' => $sendAt, 'return_path_domain' => $returnPathDomain];
