...
class Templates
{
     ...
     */
    public function add($name, $fromEmail = null, $fromName = null, $subject = null, $code = null, $text = null, $publish = true, $labels = [])
    {
        $_params = ['name' => $name, 'from_email' => $fromEmail, 'from_name' => $fromName, 'subject' => $subject, 'code' => $code, 'text' => $text, 'publish' => $publish, 'labels' => $labels];
     ...
     */
    public function render($templateName, $templateContent, $mergeVars = null) // phpcs:enable Generic.Files.LineLength.TooLong
    {
        $_params = ['template_name' => $templateName, 'template_content' => $templateContent, 'merge_vars' => $mergeVars];
